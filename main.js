...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/SWtB-6rhq/model.json',modelLoaded)
...
function gotResult(error,result)
{
    ...
    else
    {
        ...
        if(result[0].label == "Thumb Up")
        {
            document.getElementById('update_emoji').innerHTML = "&#128077";
        }

        if(result[0].label == "Thumb Down")
        {
